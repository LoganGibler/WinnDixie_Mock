...
const Coupons = ({ coupons }) => {
  return (
    <div className="flex flex-col pb-[3rem]">
      <div className="flex pl-4 md:px-[1rem] md:justify-center pb-2 border-b-[1px] border-slate-300">
      ...
      <div className="flex flex-col mt-2 md:flex-row md:justify-center">
        {coupons.map((coupon, index) => {
          return (
            <div
              className="flex bg-inherit py-4 px-3 border-b-[1px] border-slate-300 md:flex-col md:mx-2.5 md:rounded-md md:border-[1px] md:border-slate-300 md:mt-2 md:px-2 md:py-3 md:w-[260px]"
              key={index}
            >
