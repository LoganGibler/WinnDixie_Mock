...
const DropdownMenu = ({ options, showDropdown }) => {
  ...
  return (
    ...
    >
      <div className="absolute flex mt-1 bg-white rounded-br-lg rounded-tr-lg rounded-bl-lg shadow-xl">
          ...
          {options.length
            ? options.map((option, index) => {
                return (
                  <div key={index}>
                    <div
                      className="flex px-2 py-2 text-base text-black hover:bg-slate-300 hover:cursor-pointer rounded-lg"
